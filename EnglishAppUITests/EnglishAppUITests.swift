...
//    }
    ...
    func testTestingTranslation() throws {
     
        let app = XCUIApplication()
        app.launch()
        app.tabBars["Tab Bar"].buttons["Словарь"].tap()
        app.navigationBars["Словарь"].buttons["Add"].tap()

       
        XCTAssert(app.buttons["translate"].exists)
